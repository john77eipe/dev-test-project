...
public class ApplicationConstants {
	...
	public enum ConfigParameter {
		...
		CITY_NAME("C", false, "city", "Name of the city; This option is mandatory. "),
		FILE_LOCATION("L", false, "fileLoc", "Location and name of the CSV file; Default: ~/<city name>.csv"),
		FILE_TYPE("T", false, "fileType", "Type of the file; Default: CSV"),
		DATA_WRITER_CLASS("W", false, "writer", "Writer implementation class to be used, Default: CSVWriterImpl.class");
